# Recursos - Semana 4: APIs y Backend Integration

## 📚 Material Complementario

Esta carpeta contiene recursos adicionales para profundizar en los temas de la semana 4: consumo de APIs, autenticación y manejo de datos asincrónicos en React Native.
...
1. **"HTTP: The Definitive Guide"** (Selecciones)
   ...
   - 🎯 Recomendado: Antes de la sesión presencial

2. **"RESTful Web APIs"** by Leonard Richardson (Capítulos 1-3)
   - 📍 Ubicación: `./ebooks-free/restful-web-apis-intro.pdf`
   - 📝 Contenido: Principios REST, diseño de APIs
   - ⏱️ Tiempo: ~1.5 horas
   - 🎯 Recomendado: Durante trabajo autónomo
...
3. **"JavaScript Promises and Async/Await"**
   ...
   - ⏱️ Tiempo: ~2 horas
   - 🎯 Recomendado: Para reforzar conceptos asíncronos

4. **"Authentication & Authorization in Web Applications"**
   - 📍 Ubicación: `./ebooks-free/auth-web-apps.pdf`
   - 📝 Contenido: JWT, OAuth, tokens, seguridad
   - ⏱️ Tiempo: ~2.5 horas
   - 🎯 Recomendado: Complemento a teoría de autenticación

### Advanced

5. **"API Security Best Practices"**
   - 📍 Ubicación: `./ebooks-free/api-security-practices.pdf`
   - 📝 Contenido: Vulnerabilidades, OWASP, protección
   - ⏱️ Tiempo: ~3 horas
   - 🎯 Recomendado: Para profundizar en seguridad
...
2. **"JWT Authentication Complete Guide"**
   ...
   - 🎯 Ver: Antes de ejercicios de autenticación

3. **"React Native + Axios Tutorial"**
   - 🔗 Link: [Ver README de videografía](./videografia/README.md)
   - ⏱️ Duración: 18 min
   - 📝 Temas: Configuración, interceptores, error handling
   - 🎯 Ver: Alternativa a fetch
...
6. **"Handling Loading States in React Native"**
   - 🔗 Link: [Ver README de videografía](./videografia/README.md)
   - ⏱️ Duración: 15 min
   - 📝 Temas: UX patterns, ActivityIndicator, skeleton screens
...
8. **"API Error Handling Best Practices"**
   - 🔗 Link: [Ver README de videografía](./videografia/README.md)
   - ⏱️ Duración: 20 min
   - 📝 Temas: User-friendly errors, retry strategies, offline handling
...
4. **React Native AsyncStorage**
   - 🔗 Link: [Ver README de webgrafía](./webgrafia/README.md)
   - 📝 Contenido: Instalación, API, mejores prácticas
   - 🎯 Usar: Para persistencia general
...
7. **"Handling Race Conditions in React"**
   - 🔗 Link: [Ver README de webgrafía](./webgrafia/README.md)
   - 📝 Temas: useEffect cleanup, AbortController
   - ⏱️ Lectura: ~12 min
...
10. **Postman / Insomnia**
    - 🔗 Link: [Ver README de webgrafía](./webgrafia/README.md)
    - 📝 Función: Probar APIs antes de implementar
...
- ✅ Ten la documentación oficial abierta para consultas rápidas
- ✅ Usa JWT.io para debuggear tokens en ejercicios
- ✅ Postman/Insomnia para probar endpoints antes de codear
- ❌ No intentes leer ebooks completos durante la clase
...
├── ebooks-free/
│   ├── README.md                # Lista detallada de ebooks
│   ├── http-definitive-guide-selections.pdf
│   ├── restful-web-apis-intro.pdf
│   ├── js-async-programming.pdf
│   ├── auth-web-apps.pdf
│   └── api-security-practices.pdf
├── videografia/
│   └── README.md                # Links a videos con descripciones
└── webgrafia/
    └── README.md                # Links a artículos y docs oficiales
```
...
4. **Resume en tus palabras**: Explica conceptos como si enseñaras
...
- **Recursos no disponibles**: Reportar en foro
- **Sugerencias de recursos**: Bienvenidas en sesión presencial
- **Dificultad con material**: Office hours martes/jueves 4-6pm
