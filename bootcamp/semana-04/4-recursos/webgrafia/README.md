# Webgrafía - Semana 4: APIs y Backend
...
- **Contenido**:
  - API completa de fetch
  - Ejemplos de uso
  - Opciones de configuración
  - Manejo de respuestas
- **Cuándo usar**: Referencia constante durante desarrollo
...
- **Cuándo usar**: Al implementar Axios en tu proyecto
- **Idioma**: Inglés
...
- **Contenido**:
  ...
  - Best practices
- **Cuándo usar**: Para almacenar tokens de forma segura
- **Idioma**: Inglés
...
- **Cuándo usar**: Para persistencia de datos generales
- **Idioma**: Inglés
...
- **Cuándo usar**: Para entender networking en RN
- **Idioma**: Inglés
- **⭐ Rating**: 4/5 - Básica pero oficial
...
- **Temas**:
  - Librerías para fetching de datos
...
- **Temas**:
  ...
  - Protected routes
- **Nivel**: Intermediate
- **⭐ Rating**: 4/5 - Tutorial completo paso a paso
...
- **Cuándo usar**: Al debuggear autenticación
...
- **Función**:
  - Lista completa de status codes
  - Explicación de cada código
  - Ejemplos de uso
- **Cuándo usar**: Al manejar respuestas HTTP
- **Gratis**: ✅
...
- **Tipo**: Cliente HTTP
- **Función**:
  - Probar APIs antes de implementar
  - Organizar colecciones de endpoints
  - Automatizar tests
  - Generar código
- **Cuándo usar**: Durante desarrollo y testing
...
- **Función**:
  - Similar a Postman
  - UI más simple
  - GraphQL support integrado
- **Cuándo usar**: Alternativa más ligera a Postman
...
- **Función**:
  - API fake para testing
  - Endpoints completos (users, posts, comments)
  - No requiere auth
  - Perfecto para prácticas
- **Cuándo usar**: Para practicar fetch sin backend real
- **Gratis**: ✅ Completamente gratis
...
- **Función**:
  - Probar APIs sin instalar nada
  - Compartir peticiones con equipo
  - Soporta todos los métodos HTTP
- **Cuándo usar**: Testing rápido sin instalar
- **Gratis**: ✅ Con limitaciones
- **⭐ Rating**: 4/5 - Conveniente para pruebas rápidas
...
- **⭐ Rating**: 4/5 - Completo para referencia
...
- **Nivel**: Beginner
- **⭐ Rating**: 5/5 - Muy completo y gratuito
...
- **Cuándo usar**: Para practicar con APIs reales
...
- **Función**: 
  ...
  - Sin auth requerida
  - Paginación, filtros
- **Cuándo usar**: Para proyectos de práctica
- **⭐ Rating**: 5/5 - Muy usada para aprender
...
- **Cuándo usar**: Para mantenerte actualizado
...
- **Cuándo usar**: Para conocer novedades oficiales
...
2. **Practica con herramientas**:
   - Postman → JSONPlaceholder → Tu proyecto
...
- [ ] Unirte a comunidades (Dev.to, Stack Overflow)
...
**¿Encontraste un recurso útil?** Compártelo en el foro del bootcamp!

---

## 📞 Soporte

- **Link roto**: Reportar en foro con detalles
- **Sugerencias**: Bienvenidas en sesión presencial
- **Dudas sobre recursos**: Office hours martes/jueves 4-6pm
